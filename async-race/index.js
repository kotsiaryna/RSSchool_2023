...
/***/ "./src/components/winner/heading-view.ts":
/*!***********************************************!*\
  !*** ./src/components/winner/heading-view.ts ***!
  \***********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {

eval("\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.winnersAmountView = exports.heading = void 0;\nconst createElement_1 = __importDefault(__webpack_require__(/*! ../../utils/createElement */ \"./src/utils/createElement.ts\"));\nfunction createHeading() {\n    const heading = (0, createElement_1.default)({\n        tag: \"h2\",\n        className: [\"heading\", \"winners__heading\"],\n        text: \"Winners \",\n    });\n    const winnersAmount = 0;\n    const winnersAmountView = (0, createElement_1.default)({\n        tag: \"span\",\n        className: [\"winners__count\"],\n        text: `(${winnersAmount})`,\n    });\n    heading.append(winnersAmountView);\n    return [heading, winnersAmountView];\n}\nconst [heading, winnersAmountView] = createHeading();\nexports.heading = heading;\nexports.winnersAmountView = winnersAmountView;\n\n\n//# sourceURL=webpack://async-race/./src/components/winner/heading-view.ts?");

/***/ }),

/***/ "./src/components/winner/winner-page-view.ts":
/*!***************************************************!*\
  !*** ./src/components/winner/winner-page-view.ts ***!
  \***************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {

eval("\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.pageCountView = exports.pageHeading = void 0;\nconst createElement_1 = __importDefault(__webpack_require__(/*! ../../utils/createElement */ \"./src/utils/createElement.ts\"));\nfunction createPageView() {\n    const pageHeading = (0, createElement_1.default)({\n        tag: \"h3\",\n        className: [\"winners__pages\"],\n        text: \"Page \",\n    });\n    const pageCount = 1;\n    const pageCountView = (0, createElement_1.default)({\n        tag: \"span\",\n        className: [\"pages__count\"],\n        text: `#${pageCount}`,\n    });\n    pageHeading.append(pageCountView);\n    return [pageHeading, pageCountView];\n}\nconst [pageHeading, pageCountView] = createPageView();\nexports.pageHeading = pageHeading;\nexports.pageCountView = pageCountView;\n\n\n//# sourceURL=webpack://async-race/./src/components/winner/winner-page-view.ts?");
